...
export type TranslationDTO = Record<LanguageTag, {
  ...
  'Map Access': string
  '${price}/month • Auto-renews monthly': (price: string) => string
...
export const R_Screen_Subscriptions: TranslationDTO = {
  'en-US': {
    ...
    '${price}/month • Auto-renews monthly': (price: string) => `${price}/month • Auto-renews monthly`,
  ...
  'pt-BR': {
    ...
    '${price}/month • Auto-renews monthly': (price: string) => `${price}/month • Renova automaticamente todo mês`,
    ...
    'Sponsor the App': 'Patrocine o Aplicativo',
