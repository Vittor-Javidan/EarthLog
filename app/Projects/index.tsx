...
import { generalSettingsButtonStyles, projectScreenStyles } from "./styles";
...
export default function ProjectsScreen() {
    ...
    return (
        <Background style={projectScreenStyles.background}>
            <GeneralSettingsButton 
                route={'/GeneralSettings'}
            />
            <Text style={projectScreenStyles.title}>
                {texts["Projects"]}
            </Text>
            <ScrollView>
            </ScrollView>
            <Link style={projectScreenStyles.link}
...
function GeneralSettingsButton(props: {
    route: Href
}) {

    return (<>
        <Link
            style={generalSettingsButtonStyles.link}
            href={props.route}
        >
            <Svg
                style={generalSettingsButtonStyles.svg} 
                width={generalSettingsButtonStyles.svg.width} 
                height={generalSettingsButtonStyles.svg.height} 
        ...
        <Image
            style={generalSettingsButtonStyles.image}
            source={require('../../assets/icons/settingsGear_WithShadow.png')}
        />
    </>)
}