    ...
    plugins: [
      ['module-resolver', {
        ...
        alias: {
          ...
          '@Assets':               './assets',
          '@AssetManager':         './src/AssetManager.ts',
          ...
          '@V2/FileServices':      './src/V2/FileServices',
          '@V2/GlobalServices':    './src/V2/GlobalServices',
          '@V2/Hooks':             './src/V2/Hooks',
          '@V2/Scopes':            './src/V2/Scopes',
          '@V2/Layers':            './src/V2/Layers',
          "@V2/Sensors":           './src/V2/Sensors',
          ...
          '@V1/FileServices':      './src/V1/FileServices',
          '@V1/GlobalServices':    './src/V1/GlobalServices',
          '@V1/Hooks':             './src/V1/Hooks',
          '@V1/Scopes':            './src/V1/Scopes',
          '@V1/Layers':            './src/V1/Layers',
          "@V1/Sensors":           './src/V1/Sensors',
